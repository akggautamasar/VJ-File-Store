...
BOT_USERNAME = environ.get("BOT_USERNAME", "Airfilesstorebot") # without @
...
DB_NAME = environ.get("DB_NAME", "Airfilesstorebot")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002579283057"))
